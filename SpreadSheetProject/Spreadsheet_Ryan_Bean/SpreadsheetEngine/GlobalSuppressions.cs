...
[assembly: SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1401:Fields should be private", Justification = "Keeping protected to be consistent with the text and value fields which were required to be protected.", Scope = "member", Target = "~F:SpreadsheetEngine.CellBase.color")]
